...
export const integrations: Integration[] = [
  ...
  },
  {
    ...
    docsUrl: "https://support.vidiq.com/en/articles/15082430-vidiq-mcp",
    plan: "Creator Pro",
    environment: "Production",
  ...
  },
  {
    ...
    color: "bg-[#4285f4]",
    chartColor: "#4285f4",
    description: "Google models for scripts, titles, and creative planning.",
    connected: false,
    maskedKey: "No credential connected",
    revealedKey: "",
    lastUsed: "Never",
    category: "Text generation",
    ...
    status: "disconnected",
    statusNote: "Add a Gemini API key to enable this integration.",
    quota: {
      used: 0,
      limit: 0,
      unit: "usage unavailable",
      resetsOn: "—",
      window: "—",
    },
    cost: {
