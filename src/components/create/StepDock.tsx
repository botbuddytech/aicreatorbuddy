...
export function StepDock({
  ...
  return (
    <>
      <div className="pointer-events-none fixed inset-x-0 bottom-0 z-20 lg:left-64">
        <div className="pointer-events-auto border-t border-border bg-background/90 px-6 py-3 backdrop-blur-md">
